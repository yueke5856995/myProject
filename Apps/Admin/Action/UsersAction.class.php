...
class UsersAction extends BaseAction {
	...
	public function toEditScore() {
		$this->isLogin ();
		$this->checkPrivelege ( 'hylb_04' );
		$m = D ( 'Admin/Users' );
		$user = $m->getUserScore ();
		$this->assign ( 'user', $user );
		$this->assign ( 'id', I ( "id" ) );
		$this->display ( "/users/edit_score" );
	}
	/**
	 * 编辑账号信息
	 */
	...
	public function getScoreList() {
		...
		$this->assign ( 'scoreType', ( int ) I ( "scoreType", - 1 ) );
		$this->assign ( 'Page', $page );
		$this->assign ( 'user', $user );
		print_r ( $userScore );
