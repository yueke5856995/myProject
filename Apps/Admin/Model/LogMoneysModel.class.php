...
class LogMoneysModel extends BaseModel {
    ...
    public function queryByPage(){
		...
		$endDate = I('endDate');
		$sql = "select l.*,u.userName,s.shopName from __PREFIX__log_moneys l left join __PREFIX__wx_users u on l.targetType=0 and dataId=u.userId 
		...
		$page = $this->pageQuery($sql,(int)I('p'),30);
		if(!empty($page['root'])){
