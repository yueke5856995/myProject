function uploadAblumInit() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server:  Think.U('Admin/shops/uploadPic') ,
            // runtimeOrder: 'flash',
            fileVal:'Filedata',
             accept: {
                 title: 'Images',
...
//	//新增相册图片
            id=$("#id").val();
            $.get(WST.APP+'/Admin/orders/addImg?',{Thumbs:obj.Filedata.savepath + obj.Filedata.savethumbname,id:id,Img:obj.Filedata.savepath + obj.Filedata.savename},function(data){
            },'json')
        }
