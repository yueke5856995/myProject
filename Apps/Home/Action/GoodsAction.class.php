...
class GoodsAction extends BaseAction {
	...
	*/
	public function queryOnSaleByPage(){
		...
		$m = D('Home/Goods');
    	$page = $m->queryOnSaleByPage($USER['shopId']);//var_dump($page);
	...
	*/
    ...
    public function toEdit(){
    	...
    	$this->assign("umark",I('umark'));
    	$p=(int)I('p',0);
    	$this->assign("pageNo",$p);
    	if($p){
        $this->display("shops/goods/edit1");
    	}else{
