 ...
 * 获取当前商品状态
 */
function getGoodsStatus($goodsType,$goodsStatus){
    switch ($goodsType){
        case 1://衣物储存
            switch ($goodsStatus){
                case 0://待存储
                    $where['goodsStatus']='待存储';
                    break;
                case 1://存储中
                    $where['goodsStatus']='存储中';
                    break;
                case 2://取回中
                    $where['goodsStatus']='待取回';
                    break;
                case 3://已取回
                    $where['goodsStatus']='已取回';
                    break;
            }
            break;
        case 2://衣物流通
            switch ($goodsStatus){
                case 0://待流通
                    $where['goodsStatus']='待流通';
                    break;
                case 1://流通中
                    $where['goodsStatus']='流通中';
                    break;
                case 2://流通完成
                    $where['goodsStatus']='流通完成';
                    break;
            }
            break;
        case 3://我要出售
            ...
            switch ($goodsStatus){
                case 0://待审核
                    $where['goodsStatus']='待审核';
                    break;
                case 1://在售
                    $where['goodsStatus']='在售';
                    break;
                case 2://售出
                    $where['goodsStatus']='已售出';
                    break;
            }
            break;
        case 4://我的购买
            switch ($goodsStatus){
                case 0://待发货
                    $where['goodsStatus']='待发货';
                    break;
                case 1://配送中
                    $where['goodsStatus']='配送中';
                    break;
                case 2://完成
                    $where['goodsStatus']='完成';
                    break;
            }
            break;
    }
    return $where['goodsStatus'];
}
