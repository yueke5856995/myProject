...
//	//新增相册图片
            ...
            $.get(WST.APP+'/Home/Goods/edits?',{Thumbs:obj.Filedata.savepath + obj.Filedata.savethumbname,id:id,Img:obj.Filedata.savepath + obj.Filedata.savename},function(data){
                //console.log(data);
            },'json')
        }
