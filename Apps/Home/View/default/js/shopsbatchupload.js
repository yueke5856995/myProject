    ...
    $(function() {
        ...
        function addFile( file ) {
            var $li = $( '<li style="border: 1px solid rgb(96,96,96)" id="' + file.id + '" onmouseover="imglimouseover(this)" onmouseout="imglimouseout(this)">' +
                    ...
                    '<input class="gallery-img-url" id="aaa" type="text" value="" style="width:118px;" placeholder="广告路径">'+
                    '</li>' ),
        ...
        uploader.onUploadSuccess=function(file,response) {
            ...
            $.get(WST.APP+'/Home/Shops/editShopCfg1',{shopAds:obj.Filedata.savepath + obj.Filedata.savename,shopAdsUrl:shopAdsUrl},function(data){
                console.log(data);
            },'json')
        }
