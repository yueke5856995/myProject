...
<html lang="zh-cn">
   <head>
      ...
      <link rel="stylesheet" href="/pjhl/Apps/Admin/View/css/login.css">
      <!--[if lt IE 9]>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            ...
                            <label class="img">
			                	<img style='vertical-align:middle;cursor:pointer;height:31px;' class='verifyImg' src='/pjhl/Apps/Home/View/default/images/clickForVerify.png' title='刷新验证码' onclick='javascript:getVerify()'/> 
							</label>
                        </div>
                    </div>
                </div>
